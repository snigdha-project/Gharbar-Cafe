...
export default function RoomCard({
  ...
  return (
    <div className="bg-white shadow-xl group overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
      {/* Image Container */}
      ...
      <div className="p-8 space-y-6">
        ...
        {/* Button */}
        <button className="w-full mt-4 group/btn relative px-10 py-4 border border-[#e6a34d] overflow-hidden transition-all duration-300">
